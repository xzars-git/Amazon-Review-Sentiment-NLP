...
def main():
    ...
    parser.add_argument('--text_column', type=str, default='reviewText', help='Name of the text column')
    parser.add_argument('--rating_column', type=str, default='overall', help='Name of the rating column')
